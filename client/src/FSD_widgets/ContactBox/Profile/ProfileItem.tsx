...
import { addFriend, logout } from '@/FSD_shared/store/slices/AuthSlice';
import { useAppDispatch } from '@/FSD_shared/lib/hooks/useAppDispatch';
import type { IUser } from '@/FSD_shared/types/Auth_Response';
import { useTypedSelector } from '@/FSD_shared/lib/hooks/useAppSelector';
import { useEffect, useState } from 'react';
import plus from '@/FSD_shared/assets/icons/plus.svg';
import check from '@/FSD_shared/assets/icons/check.svg';
import { useLocation, useNavigate } from 'react-router-dom';
import { createChat } from '@/FSD_shared/store/slices/ChatSlice';
